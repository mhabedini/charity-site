  ...
  data() {
    return {
      languages: [{
        ...
        {
          flag: require("~/assets/images/flags/fa.jpg"),
          language: "fa",
          title: "فارسی",
        },
        {
  ...
  <div class="navbar-custom">
    <div class="container-fluid">
      <ul class="list-unstyled topnav-menu float-right mb-0">
        ...
        <b-nav-item-dropdown variant="white" class="d-none d-lg-inline-block topbar-dropdown" toggle-class="nav-link"
          ...
          <div class="px-lg-2">
            <div class="row no-gutters">
              <div class="col">
                <a class="dropdown-icon-item" target="_blank" href="http://gitlab.bazarshahr.dev">
                  <img src="~/assets/images/brands/gitlab.png" alt="Github"/>
                  <span>{{ $t('navbar.dropdown.site.list.gitlab') }}</span>
                </a>
              </div>
              <div class="col">
              ...
              <div class="col">
                <a class="dropdown-icon-item" target="_blank" href="https://bazarshahr.slack.com">
            ...
            <div class="row no-gutters">
              <div class="col">
                <a class="dropdown-icon-item" target="_blank" href="https://trello.com/">
                  <img src="~/assets/images/brands/trello.png" alt="Trello"/>
                  <span>{{ $t('navbar.dropdown.site.list.trello') }}</span>
                </a>
              </div>
              <div class="col">
                <a class="dropdown-icon-item" target="_blank" href="https://mailservice5.irandns.com/roundcube/">
                  <img src="~/assets/images/brands/mail.png" alt="Email"/>
                  <span>{{ $t('navbar.dropdown.site.list.email') }}</span>
                </a>
              </div>
              <div class="col">
                <a class="dropdown-icon-item" target="_blank" href="https://www.dropbox.com/home/Bazarshahr">
        ...
        <b-nav-item-dropdown v-if="false" variant="white" class="d-none" right toggle-class="header-item">
          <template v-slot:button-content>
        ...
        <b-nav-item-dropdown v-if="false" right class="notification-list" menu-class="dropdown-lg">
        ...
        <li v-if="false" class="dropdown notification-list">
      ...
      <ul class="list-unstyled topnav-menu topnav-menu-left m-0">
        ...
        <b-nav-item-dropdown class="dropdown-mega d-none" variant="black" menu-class="dropdown-megamenu">
          <template v-slot:button-content>
